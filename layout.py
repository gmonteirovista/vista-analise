    ...
    html.Div([
        ...
        html.Div([
            ...
            html.H6(
                ...
                className="subtitle padded", style={'margin-top': '0.5em'}
            ),
            ...
            html.Div([
                html.Div(
                    dash_table.DataTable(
                        ...
                        columns=[{'id': 'Type', 'name': 'Tipo', 'type': 'text'},
                                 {'id': 'Total', 'name': 'PnL por Tipo', 'type': 'numeric',
            ...
            html.Div([
                html.Div(
                    dash_table.DataTable(
                        ...
                        columns=[{'id': 'TickerLote', 'name': 'Ação', 'type': 'text'},
                                 {'id': 'VarPU', 'name': 'Δ Preço', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'VarPnL', 'name': 'PnL', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'VarAmount', 'name': 'Δ Quantidade', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'ExposicaoDia', 'name': 'Exposição', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'Liquidez', 'name': 'Liquidez (Dias)', 'type': 'numeric'},
                                 {'id': 'Subsetor', 'name': 'Subsetor', 'type': 'text'}
                                 ],
                        editable=True,
                        style_table={'height': 'auto', 'border': 'thin grey solid'},
                        sort_action="native",
            ...
            html.Div([
                html.Div(
                    dash_table.DataTable(
                        ...
                        columns=[{'id': 'TickerLote', 'name': 'Opção', 'type': 'text'},
                                 {'id': 'VarPnL', 'name': 'PnL', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'ExposicaoDia', 'name': ' Exposição Δ', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'DateExpiry', 'name': 'Vencimento', 'type': 'text'},
                                 {'id': 'Liquidez', 'name': 'Liquidez (Dias)', 'type': 'numeric'},
                                 ],
                        editable=True,
                        style_table={'height': 'auto', 'border': 'thin grey solid'},
        ...
        html.Div([
            html.H6(
                    "IBOVESPA - MAIORES ALTAS, BAIXAS E MAIS NEGOCIADAS",
            ...
            html.Div([
                html.Div(
                    dash_table.DataTable(
                        ...
                        columns=[{'id': 'Ticker', 'name': 'Ação', 'type': 'text'},
                                 {'id': 'ChangePrice', 'name': 'Δ Preço', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 ],
                        style_header={'backgroundColor': 'rgb(174, 153, 103)', 'fontWeight': 'bold',
                                      'color': 'rgb(79, 59, 39)'},
        ...
        html.Div([
            html.H6(
                "Page 2",
                className="espacopagina espaco", style={'margin-top': '5em'}
            ),
            html.H6(
                "ANÁLISE DE ALOCAÇÃO SETORIAL",
                    ...
                    dash_table.DataTable(
                        ...
                        columns=[{'id': 'Subsetor', 'name': 'Subsetor', 'type': 'text'},
                                 {'id': 'ExposicaoVista', 'name': 'Exp. Vista', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'ExposicaoIBOV', 'name': 'Exp. Benchmark', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'Alfa', 'name': 'Δ Exposição', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'ReturnVista', 'name': 'PnL Vista', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
                                 {'id': 'ReturnIBOV', 'name': 'PnL Benchmark', 'type': 'numeric',
                                  'format': FormatTemplate.percentage(2).sign(Sign.positive)},
        ...
        html.Div([
            html.H6(
                "CAIXA E MOVIMENTAÇÃO DE PASSIVO",
...
def update_data(date, value):
    ...
    figure = {'data': [go.Bar(x=data_2.index,
                              ...
                              name='Vista Capital',
                              marker={'color': 'rgb(174, 153, 103)'},
                              text=list(round(data_2['ExposicaoDia_vista'], 1)),
                              textposition="outside",
                              ),
                       go.Bar(x=data_2.index,
                              ...
                              name='Ibovespa',
                              marker={'color': 'rgb(64, 140, 168)'},
                              text=list(round(data_2['ExposicaoDia_ibov'], 1)),
                              textposition="outside"
                             )
                       ],
              'layout': {'title': '<b>EXPOSIÇÃO POR SUBSETOR (%PL)</b>',
                         'xaxis': {'showgrid': False},
...
def update_data(date, value):
    ...
    figure = {'data': [go.Bar(x=data_2.index,
              ...
              'layout': {'title': '<b>EXPOSIÇÃO POR SETOR (%PL)</b>',
                         'xaxis': {'showgrid': False},
                         'yaxis': {'showgrid': False},
                         'plot_bgcolor': 'rgba(0, 0, 0, 0)',
                         'paper_bgcolor': 'rgba(0, 0, 0, 0)',
...
def update_data(date, value):
    ...
    figure = {'data': [go.Bar(x=equity_option.index,
                              ...
                              name='À Vista',
                              marker={'color': 'rgb(174, 153, 103)'},
                              text=list(round(equity_option['Stocks'], 1)),
                              textposition="outside",
                              ),
                       go.Bar(x=equity_option.index,
                               y=equity_option['Options'],
                               name='Opções',
                               marker={'color': 'rgb(64, 140, 168)'},
                               text=list(round(equity_option['Options'], 1)),
                               textposition="outside"
                              )
                       ],
              'layout': {'title': '<b>EXPOSIÇÃO POR TICKER (%PL)</b>',
                         'xaxis': {'showgrid': False},
                         'yaxis': {'showgrid': False},
                         'plot_bgcolor': 'rgba(0, 0, 0, 0)',
                         'paper_bgcolor': 'rgba(0, 0, 0, 0)',
...
def update_data(value):
    ...
    performance_attribution['ExposicaoVista'] = 0.00
    performance_attribution['ReturnVista'] = 0.00
    performance_attribution['ExposicaoIBOV'] = 0.00
    performance_attribution['ReturnIBOV'] = 0.00
    performance_attribution['Alfa'] = 0.00
    performance_attribution['PureSectorAllocation'] = 0.00
    performance_attribution['WithinSectorAllocation'] = 0.00
    performance_attribution['InteractionEffect'] = 0.00
    performance_attribution['Attribution'] = 0.00
